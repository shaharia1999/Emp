...
const DashBoardHome = () => {
  ...
  return (
    <div className="  px-10">
      {/* <h1 className="font-bold text-2xl text-center mt-6 text-[#0891B2]">Your History</h1> */}
      <div className=" px-10 ">
        ...
        <div className="col-span-2 ">
          <div className="">
            <div className="flex justify-between items-center shadow-lg  py-6 border px-5 my-2">
              <div>
                <MdTask className="text-3xl text-blue-500" />
              </div>
              <div>
                <p>Total Task</p>
            ...
            <div className="flex justify-between items-center shadow-lg  py-6 border px-5 my-2">
              <div>
                <MdTask className="text-3xl text-red-500" />
              </div>
              <div>
                <p>Total Task</p>
                <p className="text-center text-2xl">34 +</p>
            ...
            <div className="flex justify-between items-center shadow-lg  py-6 border px-5 my-2">
              <div>
                <MdTask className="text-3xl text-green-500" />
              </div>
              <div>
                <p>Total Task</p>
                <p className="text-center text-2xl">34 +</p>
            ...
            <div className="flex justify-between items-center shadow-lg  py-6 border px-5 my-2">
              <div>
                <MdTask className="text-3xl text-yellow-500" />
              </div>
              <div>
                <p>Total Task</p>
                <p className="text-center text-2xl">34 +</p>
